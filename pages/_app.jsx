...
export default function AwardApp({ Component, pageProps }) {
  ...
  const NavItems = [
    ...
    },
    {
      ...
      href: "https://discord.gg/hVY97BFg9M",
    },
    {
      link: true,
      name: "Add Bot",
      ...
      href: "https://discord.com/oauth2/authorize?client_id=784214130202509333&permissions=8&scope=bot%20applications.commands",
    },
       {
      link: true,
      name: "Vote",
      ...
      href: "https://top.gg/tr/bot/784214130202509333",
    },
    {
      link: true,
      name: "Partners",
